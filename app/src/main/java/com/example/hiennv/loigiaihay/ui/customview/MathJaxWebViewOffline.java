...
public class MathJaxWebViewOffline extends WebView {
    public MathJaxWebViewOffline(Context context) {
        super(context);
        clearCache(true);
    ...
    public MathJaxWebViewOffline(Context context, AttributeSet attributeSet) {
    ...
    public MathJaxWebViewOffline(Context context, AttributeSet attributeSet, int i) {
